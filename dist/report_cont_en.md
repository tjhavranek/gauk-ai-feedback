...
WHAT THE PUBLISHED RULES REQUIRE
  ...
  - The money asked for next year is specified and justified in the
    text, item by item and in Czech crowns, except the overhead, under
    the same rules as a new application. It may exceed the outlook in
    the original application by at most 10 percent.
