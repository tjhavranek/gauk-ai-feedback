...
Kontrolujete ŽÁDOST O POKRAČOVÁNÍ spolu s VÝROČNÍ ZPRÁVOU za končící rok.
Podávají se jako jeden celek: peníze na další rok a zpráva za rok
uplynulý, jejíž částmi jsou zpráva o řešení, výhled, přehled vyčerpaných
financí, komentář k nim a seznam dosažených výsledků.

Termín: Závazný je fakultní termín; rektorátní termín je 21. ledna 2027.
Žádost podává i řešitel přerušeného projektu.
...
CO ŽÁDAJÍ ZVEŘEJNĚNÁ PRAVIDLA
  ...
  - Jde o dvě věci najednou: peníze na další rok a výroční zprávu za
    končící rok, a ta má vlastních pět částí (zpráva o řešení, výhled,
    přehled vyčerpaných financí, komentář k nim a seznam dosažených
    výsledků).
  ...
  - Změnu během roku uveďte a zdůvodněte: proč k ní došlo, na co
    peníze místo toho šly a proč nebyly použity podle plánu. Přesun do
    20 000 Kč v jednom ukazateli se žádat nemusí (do osobních nákladů
    10 000 Kč) a jednotlivé přesuny se sčítají. Schválenou změnu v
    žádosti uveďte.
  - Nedočerpané peníze se vracejí GA UK i s poměrnou částí doplňkových
    nákladů a v žádosti se to uvede.
  - Každý výsledek, který zmíníte, přiložte jako soubor, nejen ho
    popište: data, publikaci, rukopis, potvrzení o přijetí do tisku,
    patent. U cesty hrazené z projektu přiložte, co z ní vzešlo, třeba
    abstrakt, poster nebo přednášku.
  - Každý výstup nese afiliaci univerzity a fakulty a dedikaci GA UK s
    ...
    se neuzná.
  - Řešitelský kolektiv lze měnit bez žádosti o změnu, kromě hlavního
    řešitele a vedoucího projektu; napište to a zdůvodněte v
    charakteristice kolektivu.
