...
Kontrolujete ZÁVĚREČNOU ZPRÁVU, kterou projekt podává na konci řešení.
Podává ji i projekt, který skončil předčasně, a projekt s odloženým
hodnocením podává po roce doplněnou závěrečnou zprávu.

Termín: Závazný je fakultní termín; rektorátní termín je 1. dubna 2027.
Zprávu podává i projekt, který skončil předčasně.
...
CO ŽÁDAJÍ ZVEŘEJNĚNÁ PRAVIDLA

  - Výsledek se přikládá, ne popisuje: abstrakt z konference, poster,
    předběžná data, publikace, rukopis, potvrzení o přijetí do tisku,
    patent. Samotný komentář nestačí.
  - Jako splněný se projekt hodnotí podle původní publikace přijaté do
    tisku, případně patentu; v sekci C jde o publikaci v impaktovaném
    časopise. Výstup se musí týkat tématu projektu, cíle měnit nelze.
  - Autorem nebo spoluautorem musí být student z týmu. Výstup
    samotného vedoucího projektu není výsledkem projektu, proto ho
    neuvádějte.
  - Napište, co se za peníze pořídilo, nejen souhrnně, ale po
    jednotlivých platbách, v korunách. Změnu uveďte i s důvodem,
    včetně toho, proč se peníze nečerpaly tam, kde byly plánované;
    nedočerpané se vracejí i s podílem doplňkových nákladů.
  - Chcete-li odklad hodnocení, zpráva musí zpoždění zdůvodnit a musí
    k ní být přiložen rukopis připravované publikace; stačí
    rozpracovaný. Druhý odklad je jen pro mateřskou a rodičovskou
    dovolenou nebo doloženou dlouhodobou nemoc a žádá se u kanceláře
    GA UK. Třetí není.
  - Každý výstup nese afiliaci univerzity a fakulty a dedikaci GA UK s
    číslem projektu z aplikace, včetně posterů a abstraktů. Bez nich
    se neuzná.
